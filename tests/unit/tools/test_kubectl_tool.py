...
from core.tools.kubectl_tool import kubectl_apply_dry_run


class TestKubectlTool:
    """Test cases for kubectl tool."""

    @patch('core.tools.kubectl_tool.subprocess.run')
    ...
    def test_kubectl_apply_dry_run_return_type(self):
        ...
        with patch('core.tools.kubectl_tool.subprocess.run') as mock_run:
            mock_proc = Mock()
            mock_proc.returncode = 0
