...
import pytest
from core.agents_and_tools.tools.psql_tool import psql_exec


class TestPsqlTool:
    """Test cases for psql tool."""

    @patch('core.agents_and_tools.tools.psql_tool.subprocess.run')
    ...
    def test_psql_exec_return_type(self):
        ...
        with patch('core.agents_and_tools.tools.psql_tool.subprocess.run') as mock_run:
            mock_proc = Mock()
            mock_proc.returncode = 0
