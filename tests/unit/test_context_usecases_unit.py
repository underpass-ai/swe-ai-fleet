...
class TestProjectDecisionUseCase:
    ...
    def test_execute_with_all_fields(self):
        ...
        mock_writer.upsert_entity.assert_called_once_with(
            "Decision", "DEC-001", {"kind": "architecture", "summary": "Use microservices"}
        )

        # Should create relationship to subtask
        mock_writer.relate.assert_called_once_with(
            "DEC-001", "AFFECTS", "SUB-001", src_labels=["Decision"], dst_labels=["Subtask"]
        )
    ...
    def test_execute_without_optional_fields(self):
        ...
        mock_writer.upsert_entity.assert_called_once_with("Decision", "DEC-001", {"kind": "", "summary": ""})
    ...
    def test_execute_without_sub_id(self):
        ...
        payload = {"node_id": "DEC-001", "kind": "design", "summary": "Use REST API"}
        usecase.execute(payload)
...
class TestProjectPlanVersionUseCase:
    ...
    def test_execute_without_version(self):
        ...
        mock_writer.upsert_entity.assert_called_once_with("PlanVersion", "PLAN-001", {"version": 1})
...
class TestProjectSubtaskUseCase:
    ...
    def test_execute_with_empty_title(self):
        ...
        payload = {"plan_id": "PLAN-001", "sub_id": "SUB-001", "title": "", "type": "testing"}
        usecase.execute(payload)

        mock_writer.upsert_entity.assert_called_once_with(
            "Subtask", "SUB-001", {"title": "", "type": "testing"}
        )
