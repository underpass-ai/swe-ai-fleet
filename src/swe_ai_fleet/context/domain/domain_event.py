# src/swe_ai_fleet/context/domain/domain_event.py
...
class DomainEvent:
    ...
    def case_created(case_id: str, name: str = "") -> DomainEvent:
        ...
        return DomainEvent(
            ...
            payload={"case_id": case_id, "name": name}
        )
    ...
    def plan_versioned(case_id: str, plan_id: str, version: int = 1) -> DomainEvent:
        ...
        return DomainEvent(
            event_type="plan.versioned",
            payload={"case_id": case_id, "plan_id": plan_id, "version": version}
        )
    ...
    def subtask_status_changed(sub_id: str, status: str | None) -> DomainEvent:
        ...
        return DomainEvent(
            ...
            payload={"sub_id": sub_id, "status": status}
        )
    
    @staticmethod
    def decision_made(node_id: str, kind: str = "", summary: str = "", 
                     sub_id: str | None = None) -> DomainEvent:
