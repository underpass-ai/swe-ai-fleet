...
```go
import "github.com/underpass-ai/swe-ai-fleet/gen/fleet/orchestrator/v1"
```

---

*This documentation is auto-generated from `specs/fleet/orchestrator/v1/orchestrator.proto`*
