...
## 7. Monitoring Service (`services/monitoring`)
**"The Dashboard"**

Real-time visibility into the fleet.
-   **Responsibilities**:
    -   Aggregates NATS events.
    -   Visualizes active Councils and Deliberations.
    -   Monitors Ray Cluster health and GPU usage.
-   **Key Tech**: Python (FastAPI), React, NATS.
