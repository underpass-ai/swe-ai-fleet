...
| | Responsibility | Who |
|---|---|---|
| **The "Why"** | **Intent, Business Value, Ethical Constraints** | 👤 **Human** |
| **The "How"** | **Implementation, Boilerplate, Testing, Syntax** | 🤖 **AI Fleet** |
| **The "What"** | **Verification, Approval, Deployment** | 👤 **Human** |
...
### 🚪 Gate 1: The Product Definition (PO Review)
**Service**: `Planning Service`
**State**: `PO_REVIEW` → `READY_FOR_PLANNING`
...
### 🚪 Gate 2: The Technical Plan (Architect Review)
**Service**: `Planning Service` / `Task Derivation`
**State**: `PLAN_REVIEW` → `PLANNED`
...
### 🚪 Gate 3: The Implementation (Code Review)
**Service**: `Workflow Service`
**State**: `CODE_REVIEW` → `TESTING`
...
### 🚪 Gate 4: The Exception Handle (Manual Intervention)
**Service**: All
